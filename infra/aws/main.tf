# Physics Simulation API - AWS Infrastructure
# This Terraform configuration deploys the Physics Simulation API to AWS using ECS Fargate
...
terraform {
  ...
  #   key    = "physics-sim-api/terraform.tfstate"
  #   region = "us-west-2"
  # }
}
...
provider "aws" {
  ...
  default_tags {
    tags = {
      Project     = "physics-simulation-api"
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description                = "Redis cluster for Physics Simulation API"
